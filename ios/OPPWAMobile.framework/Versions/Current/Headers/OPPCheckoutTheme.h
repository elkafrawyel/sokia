...
/**
 ...
 @warning **Deprecated:** Use `paymentBrandIconBackgroundColor` instead.
 */
@property (nonatomic) UIColor *paymentMethodIconBackgroundColor DEPRECATED_ATTRIBUTE;

/**
 Background color of text fields.
 @warning **Deprecated:** since 2.11.0.
 */
@property (nonatomic) UIColor *textFieldBackroundColor DEPRECATED_ATTRIBUTE;
